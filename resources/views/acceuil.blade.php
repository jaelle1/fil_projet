...
<main class="main" id="top">
        ...
        <div class="swiper-slide" data-zanim-timeline="{}">
          ...
          <div class="container">
            <div class="row min-vh-100 py-8 align-items-center" data-inertia='{"weight":1.5}'>
              <div class="col-sm-8 col-lg-7 px-5 px-sm-3">
                <div class="overflow-hidden ">
                  <h1 class="fs-4 fs-md-5 lh-1 text-white"
               data-zanim-xs='{"delay":0}'>BIENVENUE SUR SEGTABA</h1>
                </div>
                <div class="overflow-hidden ">
  ...
  <section>
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 pe-lg-3"><img class="rounded-3 img-fluid" src="{{asset('img/istockphoto-1016963656-612x612.jpg')}}" alt="about" /></div>
        <div class="col-lg-6 px-lg-5 mt-6 mt-lg-0" data-zanim-timeline="{}" data-zanim-trigger="scroll">
          <div class="overflow-hidden">
            <div class="px-4 px-sm-0" data-zanim-xs='{"delay":0}'>
              ...
              <p class="mt-3">Segtaba est un site de mise en relation entre les agences de communication et les entreprises.Ce site va relier directement les entreprises à la recherche de prestataires de services pour booster leur stratégie marketing avec les agences de communication qui vont proposer leur service.
    ...
    <div class="container">
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card">
            <img class="card-img-top h-50 w-50 text-center" src="{{asset('storage/.$entreprise->avatar')}}" alt=" " />
          </a>
            <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
              <div class="overflow-hidden">
