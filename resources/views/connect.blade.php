          ...
          <div class="col-md-8 col-lg-5 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
            ...
            <div class="card" data-zanim-xs='{"delay":0.1,"duration":1}'>
              <div class="card-body p-md-5">
                ...
                <form class="text-start mt-4" method="POST" action="{{route('voyager.postlogin')}}">
                  @csrf
                  <div class="row align-items-center">
                    <div class="col-12">
                      <div class="input-group">
                        ...
                        <input class="form-control" type="email" placeholder="votre adresse email" aria-label="Text input with dropdown button" name='email' />
                        @error('email')
                    ...
                    <div class="col-12 mt-2 mt-sm-4">
                      <div class="input-group">
                        ...
                        <input class="form-control" type="Password" placeholder="Password" aria-label="Text input with dropdown button" name='password' />
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="row align-items-center mt-3">
                    ...
                    <div class="col-6 mt-2 mt-sm-3"><button class="btn btn-primary w-100" type="submit">Connecter</button></div>
                  </div>
                </form>
              </div>
            </div>
